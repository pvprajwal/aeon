...
class RClusteringMiniRocket(BaseCollectionTransformer):
    ...
    def _transform(self, X, y=None):
        ...
        if n_channels == 1:
            ...
            X_ = _static_transform_uni(
                X, self.parameters, RClusteringMiniRocket._indices
            )
        else:
...
def _static_fit(X, n_features=10_000, max_dilations_per_kernel=32, seed=None):
    ...
    biases = _fit_biases(
        ...
        quantiles,
        RClusteringMiniRocket._indices,
        seed,
    )
    return (
        n_channels_per_combination,
