...
def holdit_barycenter_average(
    ...
    num_ts_to_use_percentage: float = 0.5,
    **kwargs,
) -> np.ndarray:
    ...
    num_ts_to_use_percentage: float, default=0.5
        Percentage of time series to use in each iteration.
    **kwargs
